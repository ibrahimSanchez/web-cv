    ...
    <motion.div
      ...
      >
        ...
        <motion.div 
          ...
          variants={itemVariants}
        >
          <Link href="https://github.com/ibrahimSanchez" target="_blank">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button size="lg" className="cursor-pointer gap-2 group relative overflow-hidden w-1/2 sm:w-auto">
                <span className="relative z-10 flex items-center">
                  {t.home.cta}
                  <Github className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform duration-200" />
                </span>
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button 
              size="lg" 
              variant="outline" 
              className="cursor-pointer gap-2 group border-2 w-1/2 sm:w-auto hover:text-white dark:hover:text-accent"
